...
test('should start remove expense', (done) => {
    const store = createMockStore({});
...
test('should setup edit expense action object', () => {
    const action = editExpense('123abc', { description: '123abcdesc', amount: 2000 });
    expect(action).toEqual({
        type: 'EDIT_EXPENSE',
        id: '123abc',
        updates: {
            description: '123abcdesc',
            amount: 2000
        }
    });
});
